import{b as te,S as re,U as f,c as P,N as ae,W as H,L as B,H as Y,d as ie,C as oe,B as se,e as $,M as ne,f as le,r as a,g as ue,u as N,P as me,h as R,i as G,k as q,l as he,D as ce,m as fe,n as de,o as ve,_ as pe,R as xe,a as ge,p as _e,q as Se,T as Me,j as s,V as De}from"./index-ab1d9981.js";import{u as K}from"./Gltf-41c96a7f.js";const Te=()=>parseInt(te.replace(/\D+/g,"")),Be=Te();class ye extends re{constructor(e=new P){super({uniforms:{inputBuffer:new f(null),depthBuffer:new f(null),resolution:new f(new P),texelSize:new f(new P),halfTexelSize:new f(new P),kernel:new f(0),scale:new f(1),cameraNear:new f(0),cameraFar:new f(1),minDepthThreshold:new f(0),maxDepthThreshold:new f(1),depthScale:new f(0),depthToBlurRatioBias:new f(.25)},fragmentShader:`#include <common>
